    ...
    <Stack direction={['column', 'row']} mt="8" justify="space-between" align="center" spacing="6">
      ...
      <Stack direction="row" spacing="2">
        {currentPage > 1 + siblingsCount && (
          <>
            <Item onPageChange={onPageChange} page={1} />
            {currentPage > 2 + siblingsCount && (
              <Text color="gray.500" width="4" textAlign="center">
                ...
              </Text>
            )}
          </>
        ...
        {previousPages.length > 0 &&
          previousPages.map((page) => {
            return <Item onPageChange={onPageChange} key={page} page={page} />;
          })}

        <Item onPageChange={onPageChange} page={currentPage} isCurrent />
        ...
        {currentPage + siblingsCount < lastPage && (
          <>
            ...
            <Item onPageChange={onPageChange} page={lastPage} />
          </>
        )}
      </Stack>
    </Stack>
